  ...
  <section class="container-fluid mt-5 py-5">
    <div class="row justify-content-center">
      <div class="col-12 col-md-8">
        <h1 class="display-4 title-description text-white text-shadow-bluscuro">
          {{__('ui.showAnnouncements')}} {{$product->title}}
        </h1>
            <p class="border-title-description"></p>
        <h3 class="display-5 author-description">
  ...
  <div class="container-fluid">
    <div class="row displayRedux">
      ...
      <div class="col-6 card-right bg-white show-box2 custom-description">
        ...
        <div class="card-text description-body border-h2">{{$product->body}} Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore magni officia velit deleniti inventore. Asperiores quis delectus sapiente excepturi vero minus dolorem ullam quam, iusto, soluta itaque dolore cupiditate cumque.</div>
